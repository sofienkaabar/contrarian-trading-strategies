    ...
    for i in range(len(data)):   
        ...
        try:
            ...
            if data[i, rsi_column] > lower_barrier and data[i - 1, rsi_column] < lower_barrier and \
               ...
               data[i - 4, rsi_column] > lower_barrier and data[i - 1, rsi_column] >= data[i - 3, rsi_column]:
            ...
            # Bearish signal
                 ...
                 data[i - 4, rsi_column] < upper_barrier and data[i - 1, rsi_column] <= data[i - 3, rsi_column]:
