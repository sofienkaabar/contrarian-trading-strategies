...
def signal(data, stochc_column, buy, sell):
    ...
    for i in range(len(data)):    
        ...
        try:
            ...
            # Bullish signal
            if data[i, stochc_column] < lower_barrier and data[i - 1, stochc_column] > upper_barrier:
                
                data[i + 1, buy] = 1
                     
            # Bearish signal
            elif data[i, stochc_column] > upper_barrier and data[i - 1, stochc_column] < lower_barrier:
