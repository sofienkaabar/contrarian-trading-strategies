    ...
    for i in range(len(data)):  
        ...
        try:
            ...
            if data[i, stoch_column] > lower_barrier and data[i - 1, stoch_column] < lower_barrier and \
               ...
               data[i - 4, stoch_column] < lower_barrier and data[i - 5, stoch_column] < lower_barrier:
            ...
            # Bearish signal
               ...
               data[i - 4, stoch_column] > upper_barrier and data[i - 5, stoch_column] > upper_barrier:
